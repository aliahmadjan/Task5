...
public static void InsertIntoDB(BankAccounts ba)
{
    try{
      ...
      //  System.out.println("SHFBSD");
        ...
        Connection con = DriverManager.getConnection("jdbc:oracle:thin:@//localhost:1521/XE","system", "flabbergast456");
        System.out.println("Connection Established");
        String sql = "INSERT INTO SYSTEM.ACCOUNTS (FIRST_NAME,LAST_NAME,ADDRESS,ACCNO,BAL,PHONENO,TYPE) VALUES (?,?,?,?,?,?,?)";
        System.out.println("SHFBSD");
